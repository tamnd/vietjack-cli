...
Most of these come down to network reality or how vietjack serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vietjack rate-limits like any public site. vietjack already paces
...
Where a surface is gated, vietjack reads a cookie or token you supply
...
`vietjack`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vietjack actually did
